# DATA
dataset= 'Bdd100k'
data_root = "/home/pantengteng/datasets/bdd100k/"

val_dataset= 'Bdd100k'
val_data_root = "/home/pantengteng/datasets/bdd100k/"
# val_dataset='neolix'
# val_data_root='/data/pantengteng/neolix_lane/' #
...
cls_loss_w  = 1
seg_loss_w = 1 # -1 #2
sim_loss_w = 0.1 #0.2#0.0# 0.1 relation_loss
shp_loss_w = 0.1 #0.1#0.0# 0.1 relation_dis
